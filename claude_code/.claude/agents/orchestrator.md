---
name: orchestrator
description: "Full MadAgents orchestrator — delegates all work to specialist agents (madgraph-operator, physics-expert, etc.) and ensures quality via reviewers. Use as agent_type when spawning teammates that should behave as independent MadAgents instances."
