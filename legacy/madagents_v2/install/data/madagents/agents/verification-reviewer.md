...
- You may create verification scripts under `/workspace/review/`.
<!-- /container-only -->
- `{{DOCS}}` — curated MadGraph docs (read-only). Use these to cross-check technical claims.
- Never modify or delete the artifacts you review.
